...
<body>
    <div class=" container-fluid">
        ...
        <div class=" row">
            <div class="col-10 col-lg-8 offset-1 offset-lg-2 d-flex flex-column align-items-center pb-5">
        ...
        <div class=" row shadow-lg py-5">
            <h1 class=" text-decoration-underline text-black text-center fw-bold my-5">What do we have ?</h1>
            <div class="col-12 d-flex flex-lg-row flex-column justify-content-evenly align-items-center my-3 py-5">
                <div class=" shadow-lg rounded rounded-circle d-flex flex-row justify-content-center align-items-center mt-5 mt-lg-0 category1" onmouseover="view1();" onmouseleave="hide1();">
                ...
                <div class=" shadow-lg rounded rounded-circle d-flex flex-row justify-content-center align-items-center my-5 my-lg-0 category2" onmouseover="view2();" onmouseleave="hide2();">
                ...
                <div class=" shadow-lg rounded rounded-circle d-flex flex-row justify-content-center align-items-center fs-5 mb-5 mb-lg-0 category3" onmouseover="view3();" onmouseleave="hide3();">
        ...
        <div class=" row">
            <div class=" col-12 d-flex flex-lg-row flex-column justify-content-center align-items-center my-5 py-5">
                <div class=" col-8 col-lg-3 d-flex flex-column justify-content-center align-items-center py-3">
                    <div class="  process_image1 mb-4"></div>
                    <h5 class="text-center fw-bold text-black">Fresh Food</h5>
                    <p class=" text-center text-black-50 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, quod.</p>
                </div>
                <div class=" py-3 col-8 col-lg-3 mx-lg-4 my-4 my-lg-0 d-flex flex-column justify-content-center align-items-center py-3">
                    <div class=" process_image2 mb-4"></div>
                    <h5 class="text-center fw-bold text-black">Fast Delivery</h5>
                    <p class=" text-center text-black-50 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, quod.</p>
                </div>
                <div class=" py-3 col-8 col-lg-3 d-flex flex-column justify-content-center align-items-center py-3">
                    <div class=" process_image3 mb-4"></div>
                    <h5 class="text-center fw-bold text-black">Save Money</h5>
                    <p class=" text-center text-black-50 px-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facilis, quod.</p>
                </div>
            </div>
        </div>
